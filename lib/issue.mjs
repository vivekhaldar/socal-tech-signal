...
export const REGION_ORDER = ['Drive', 'OC', 'LA', 'SD', 'Later'];

const REGION_SECTIONS = [
  ['Worth the drive', 'Drive', ['Orange County']],
...
export const loadIssue = (sourcePath) => {
  ...
  const issue = {
    ...
    webUrl: 'https://socaltech.live/',
    archiveUrl: `https://socaltech.live/issues/${slug}/`,
    featured,
    events,
